...
public class HeroSwordItem extends SwordItem implements ICustomReachItem {
    private Multimap<Attribute, AttributeModifier> customAttributes;

    public HeroSwordItem(Tiers tier, int attackDamageIn, Properties builderIn) {
        super(tier, attackDamageIn, 0.5F, builderIn);
    }

    public HeroSwordItem(ForgeTier tier, int attackDamageIn, Properties builderIn) {
        super(tier, attackDamageIn, 0.5F, builderIn);
    }
